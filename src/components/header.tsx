...
const NAV_LINKS: NavItem[] = [
  ...
  { href: FANATICO_URL, label: "En Vivo" },
  { href: FANATICO_URL, label: "Calendario" },
  { href: FANATICO_URL, label: "Ecuador" },
  { href: FANATICO_URL, label: "Grupos" },
  { href: FANATICO_URL, label: "Noticias" },
  { label: "Polla Mundialista", submenu: true },
  { href: FANATICO_URL, label: "Resultados" },
  { href: FANATICO_URL, label: "Estadios" },
  { href: FANATICO_URL, label: "Selecciones" },
];
